...
class Assignment: Equatable {
    ...
    public func save(mysql: MySQL?=nil, oldInstanceName: String, oldDeviceUUID: String, oldTime: UInt32?, enabled: Bool) throws {
    ...
    public static func getAll(mysql: MySQL?=nil) throws -> [Assignment] {
        ...
        while let result = results.next() {
            ...
            assignments.append(Assignment(instanceName: instanceName, deviceUUID: deviceUUID, time: time, enabled: enabled))
        }
        return assignments
