        ...
        if oldPokemon == nil {
            ...
            let sql = """
                INSERT INTO pokemon (
                    ...
                    level, weight, size, display_pokemon_id, capture_1, capture_2, capture_3, shiny, username, gender, 
                    map_status, form, weather, costume, pokestop_id, updated, first_seen_timestamp, changed, cell_id, 
            ...
            if updateIV {
                ivSQL = "atk_iv = ?, def_iv = ?, sta_iv = ?, move_1 = ?, move_2 = ?, cp = ?, level = ?, " +
                        "weight = ?, size = ?, display_pokemon_id = ?, capture_1 = ?, capture_2 = ?, capture_3 = ?, shiny = ?,"
            } else {
                ivSQL = ""
            }
