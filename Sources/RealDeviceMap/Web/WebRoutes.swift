    ...
    public static var routes: [Route] {
        let routes = [
            ...
            Route(method: .get, uri: "/index.css", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .homeCss,
            ...
            Route(methods: [.get, .post], uri: "/profile", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .profile,
                                         requiredPerms: [], requiresLogin: true)
            }),
            Route(methods: [.get, .post], uri: "/confirmemail", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .confirmemail,
                                         requiredPerms: [], requiresLogin: true)
            }),
            Route(method: .get, uri: "/confirmemail/{token}", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .confirmemailToken,
                                         requiredPerms: [], requiresLogin: true)
            }),
            Route(methods: [.get, .post], uri: "/resetpassword", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .resetpassword,
                                         requiredPerms: [], requiresLogin: false)
            }),
            Route(methods: [.get, .post], uri: "/resetpassword/{token}", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .resetpasswordToken,
                                         requiredPerms: [], requiresLogin: false)
            }),
            Route(method: .get, uri: "/dashboard", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .dashboard,
                                         requiredPerms: [.admin])
            }),
            Route(methods: [.get, .post], uri: "/dashboard/settings", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .dashboardSettings,
                                         requiredPerms: [.admin])
            }),
            Route(method: .get, uri: "/dashboard/devices", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .dashboardDevices,
                                         requiredPerms: [.admin])
            }),
            Route(methods: [.get, .post], uri: "/dashboard/device/assign/{device_uuid}",
                  handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .dashboardDeviceAssign,
                                         requiredPerms: [.admin])
            }),
            Route(method: .get, uri: "/dashboard/instances", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .dashboardInstances,
                                         requiredPerms: [.admin])
            }),
            Route(methods: [.get, .post], uri: "/dashboard/instance/add", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .dashboardInstanceAdd,
                                         requiredPerms: [.admin])
            }),
            Route(methods: [.get, .post], uri: "/dashboard/instance/edit/{instance_name}",
                  handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .dashboardInstanceEdit,
                                         requiredPerms: [.admin])
            }),
            Route(method: .get, uri: "/dashboard/devicegroups", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .dashboardDeviceGroups,
                                         requiredPerms: [.admin])
            }),
            Route(methods: [.get, .post], uri: "/dashboard/devicegroup/add", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .dashboardDeviceGroupAdd,
                                         requiredPerms: [.admin])
            }),
            ...
            Route(method: .get, uri: "/dashboard/instance/ivqueue/{instance_name}", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .dashboardInstanceIVQueue, 
				                         requiredPerms: [.viewMapIV], requiresLogin: true)
            }),
            Route(method: .get, uri: "/dashboard/accounts", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .dashboardAccounts,
                                         requiredPerms: [.admin])
            }),
            ...
            Route(methods: [.get, .post], uri: "/dashboard/assignment/add", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .dashboardAssignmentAdd,
                                         requiredPerms: [.admin])
            }),
            Route(methods: [.get, .post], uri: "/dashboard/assignment/edit/{uuid}", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .dashboardAssignmentEdit,
                                         requiredPerms: [.admin])
            }),
            Route(methods: [.get], uri: "/dashboard/assignment/start/{uuid}", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .dashboardAssignmentStart,
                                         requiredPerms: [.admin])
            }),
            ...
            Route(method: .get, uri: "/dashboard/users", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .dashboardUsers,
                                         requiredPerms: [.admin])
            }),
            Route(methods: [.get, .post], uri: "/dashboard/user/edit/{username}", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .dashboardUserEdit,
                                         requiredPerms: [.admin])
            }),
            Route(method: .get, uri: "/dashboard/groups", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .dashboardGroups,
                                         requiredPerms: [.admin])
            }),
            Route(methods: [.get, .post], uri: "/dashboard/group/edit/{group_name}", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .dashboardGroupEdit,
                                         requiredPerms: [.admin])
            }),
            ...
            Route(methods: [.get, .post], uri: "/dashboard/discordrule/add", handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .dashboardDiscordRuleAdd,
                                         requiredPerms: [.admin])
            }),
            Route(methods: [.get, .post], uri: "/dashboard/discordrule/edit/{discordrule_priority}",
                  handler: { (request, response) in
                WebReqeustHandler.handle(request: request, response: response, page: .dashboardDiscordRuleEdit,
                                         requiredPerms: [.admin])
            }),
