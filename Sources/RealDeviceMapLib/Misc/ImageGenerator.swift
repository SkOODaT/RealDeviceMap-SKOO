...
public class ImageGenerator {
    ...
    public static func generate() {
        let raidDir = Dir("\(Dir.projectroot)/resources/webroot/static/img/raid/")
        let gymDir = Dir("\(Dir.projectroot)/resources/webroot/static/img/gym/")
        let eggDir = Dir("\(Dir.projectroot)/resources/webroot/static/img/egg/")
        var unkownEggDir = Dir("\(Dir.projectroot)/resources/webroot/static/img/unkown_egg/")
